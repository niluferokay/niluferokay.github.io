    ...
    <header className='header'>
      ...
      <div className="home container">
        ...
        <div className="home__description">
            ...
            <p className='home__para'>As a full-stack blockchain developer, I am very passionate about sustainability and interested in pursuing a career in regenerative finance (ReFi). I have always been fascinated by the potential of technology to solve complex problems, particularly to address social and environmental challenges. I see blockchain as a powerful tool for creating transparent, secure, and decentralized systems that can help mitigate the impacts of climate change and promote regenerative practices.</p>
            <p className='home__para'>My biggest dream is to use my skills and expertise to help create innovative solutions that can make a positive impact on the environment and the world at large. I am currently exploring job opportunities in ReFi companies and organizations. I have experience working with smart contracts and decentralized applications. I am also experienced in multiple programming languages and web frameworks, including React, Node.js, and Solidity. I am passionate about working in a creative and collaborative work environment.</p>
