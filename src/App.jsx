    ...
    <header className='header'>
      ...
      <div className="home container">
        ...
        <div className="home__description">
            <p className='home__para'>I recently completed my master's degree in <a className='para__link' href="http://bis.boun.edu.tr/"  target="_blank">Business Information Systems</a> from Boğaziçi University. In my thesis, I developed a <a className='para__link' href="https://github.com/niluferokay/Sustainable-Supply-Chain-DApp"  target="_blank">blockchain-based decision support system</a> to assess the environmental and social sustainability of the supply chain and track products throughout their journey.</p> 
