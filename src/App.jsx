    ...
    <header className='header'>
      ...
      <div className="home container">
        ...
        <div className="home__description">
            ...
            <p className='home__para'>Through my research, I gained a better understanding of blockchain's incredible potential to address complex sustainability issues due to its ability to provide transparency, security and decentralization. This experience has given me a new perspective on the possibilities of technology to create positive social and environmental impacts.
            </p>
