    ...
    <header className='header'>
      ...
      <div className="home container">
        ...
        <div className="home__description">
            ...
            <p className='home__para'>My biggest dream is to use my skills and expertise to help create innovative solutions that can make a positive impact on the environment and the world at large. I am currently exploring job opportunities in ReFi companies and DAOs. I have experience working with smart contracts and decentralized applications. I am also experienced in multiple programming languages and web frameworks, including React, Node.js, and Solidity. I am passionate about working in a creative and collaborative work environment.</p>
